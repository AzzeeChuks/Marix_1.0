      ...
      <div className="w-full flex flex-col flex-1">
        ...
        <header className="w-full max-w-6xl mx-auto flex justify-between items-center py-2 shrink-0 select-none mb-6">
          <div className="flex items-center cursor-pointer" onClick={onCancel}>
            <img 
              src={marixLogoM} 
              alt="M" 
              style={{ width: '52px', height: '52px', margin: '0 -8px', objectFit: 'contain' }} 
            />
            <span style={{ fontSize: '1.05rem', color: '#452b1f', fontWeight: '700', letterSpacing: '2px', textTransform: 'uppercase' }} className="tracking-tight pt-1">
              ARIX
            </span>
          </div>

          <span style={{ fontSize: '0.85rem', textTransform: 'uppercase' }} className="hidden sm:inline-block font-black tracking-widest text-gray-400/70">
            secure gateway
          </span>
        </header>
        ...
        <div className="w-full flex flex-col items-center justify-center flex-1 my-auto pb-12">
          ...
          <div className="text-center mb-6 max-w-[420px]">
            ...
            <p className="text-xs md:text-sm text-gray-500 max-w-[320px] mx-auto leading-normal font-medium h-5">
              {authMode === 'signup' 
              ...
              {authMode === 'signup' && (
                <div className="flex flex-col gap-1 text-left animate-fadeIn">
                  ...
                  <input
                    ...
                    placeholder="John"
                    required
                    className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-marix-teal transition-colors text-[#111111]"
                  />
                </div>
              )}
